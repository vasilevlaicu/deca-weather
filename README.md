...
- [ ] Create a local application that can be run & parse args.
- [ ] Get the daily weather forecast for 10 favourite Belgian cities (hardcoded geocode?).
- [ ] Print their forecast in the terminal.
